...
async function showProjects(userInput: string) {
  ...
  const result = await streamUI({
    ...
    tools: {
      projects: {
        description:
          "Use this tool when the user asks to see projects or works. The user might use phrases like 'show projects', 'show your works', 'John's projects', or 'his works'. This tool can filter by category: 'Web3' or 'AI'",
