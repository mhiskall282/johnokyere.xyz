...
export default function OpensourcePage() {
  ...
  const opensourceStats = {
    ...
    ecosystemYears: "2+",
    notableProject: "Kayaba Labs Website",
    currentRole: "Co Founder & Lead Developer at Kayaba Labs",
    ecosystems: ["Ethereum", "Lisk", "Scroll"],
  };
        ...
        <div className={`relative z-10 max-w-7xl mx-auto transition-all duration-1000 ${
          ...
          <div className="mb-12 pt-8 sm:pt-12">
            ...
            <p className="text-foreground/70 text-sm sm:text-base max-w-3xl leading-relaxed">
              Contributing to the future of decentralized technology. Deep involvement in Ethereum, Starknet, Sui, Optimism, Lisk, Scroll, Base, and Algorand ecosystems, 
              ...
              <div className="space-y-3">
                {opensourceStats.ecosystems.map((ecosystem) => {
                  const ecosystemLogos: Record<string, string> = {
                    ...
                    Sui: "https://sui.io/favicon.ico",
                    Lisk: "https://lisk.com/favicon.ico",
                    Scroll: "https://scroll.io/favicon.ico",
            ...
            <div className="p-6 rounded-2xl bg-background/50 border border-border backdrop-blur-sm hover:bg-background/70 transition-all duration-300">
              ...
              <div className="space-y-3">
                <div className="p-3 rounded-xl bg-background/50 border border-border/50">
                  ...
                  <div className="text-sm text-foreground/60">Major contribution on the development of {opensourceStats.notableProject} </div>
                </div>
                <div className="p-3 rounded-xl bg-background/50 border border-border/50">
                  <div className="font-semibold text-foreground mb-1">{opensourceStats.currentRole}</div>
                  <div className="text-sm text-foreground/60">Contributing to {opensourceStats.ecosystems.join(", ")} ecosystem projects to drive innovation and collaboration.</div>
                </div>
              </div>
            </div>
          </div>
